(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lazy-url'), require('http-form-urlencoded')) :
	typeof define === 'function' && define.amd ? define(['exports', 'lazy-url', 'http-form-urlencoded'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.GetHttpResultUrl = {}, global.lazyUrl, global.httpFormUrlencoded));
})(this, (function (exports, lazyUrl, httpFormUrlencoded) { 'use strict';
